package com.demo.awesomepizza.domain;
...
public class Order {
    ...
    public Order(String id, String customerName, String pizzaType, Double price, String allergensNote, OrderStatusEnum status, LocalDateTime createdOn, LocalDateTime readyTime) {
        this.id = id;
